      ...
      <div>
        ...
        <section className='md:px-40 p-5 my-5 flex flex-col justify-center items-center'>
          ...
          <div className="md:grid grid-cols-4 w-full mt-10">
            ...
            <div className="shadow rounded p-5 mx-4 mb-5 md:mb-0">
              <img className='w-full md:w-full' src="https://store.whitefalconpublishing.com/cdn/shop/files/TheEnglish_CoverHB_F_large.jpg?v=1718624085" alt="book" />
